namespace Ocean.XamarinFormsSamples.View {
    ...
    public class SpeakerDetailPageViewModel : FormViewModelBaseBase, INavigationAware {
        ...
        public override void OnNavigatedTo(NavigationParameters parameters) {
            if (parameters != null && parameters.ContainsKey(GlobalConstants.Key)) {
                var speaker = parameters[GlobalConstants.Key] as Speaker;

                if (speaker != null && speaker.Name.StartsWith("Star")) {
                    base.DisplayDialog(GlobalConstants.Error, "Parameters are null or key is missing", GlobalConstants.OK, () => base.GoBack());
                } else {
