namespace Ocean.Portable.OceanValidation {
    ...
    /// <summary>
    /// Represents PostCodeRuleDescriptor
    /// </summary>
    /// <seealso cref="RuleDescriptorBase" />
    public class PostCodeRuleDescriptor : RuleDescriptorBase {
        ...
        public PostCodeRuleDescriptor(ValidateUnitedStatesOnly validateForUnitedStatesOnly, RequiredEntry requiredEntry, String customMessage, String propertyFriendlyName, String propertyName, String ruleSet, String overrideMessage)
        ...
        public PostCodeRuleDescriptor(PostalCodeValidatorAttribute e, String propertyName)
